...
var etamina = (function () {
    ...
    var core = {
             ...
             */
             getAnimationClassRule: function(params){
                var 
                ...
                if ('delay' in params) {
                    css += '\t'+etamina.prefix+'animation-delay:'+params.delay+';\n';
                }
...
//优化点、针对多个元素应用动画时keyframe的css可能相同。
    ...
    if (elements && elements.length > 0) {
        for (i = 0; i < elements.length; i += 1) {
            ...
            elemClass = etamina.getAnimationClassRule(playParam);
            //add css text into DOM style
            if(etamina.debug){
...
etamina.effects.goWithFixFrames = function(elems,playParam,animSetting,frames){
    ...
    var buildKeyframe = function(elem,index){
